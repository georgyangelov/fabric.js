(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
    ...
    translateToCenterPoint: function(point, originX, originY) {
      ...
      return fabric.util.rotatePoint(new fabric.Point(cx, cy), point, this.theta);
    },
    ...
    translateToOriginPoint: function(center, originX, originY) {
      ...
      return fabric.util.rotatePoint(new fabric.Point(x, y), center, this.theta);
    },
    ...
    toGlobalPoint: function(point) {
      return fabric.util.rotatePoint(point, this.getCenterPoint(), this.theta).addEquals(new fabric.Point(this.left, this.top));
    },
